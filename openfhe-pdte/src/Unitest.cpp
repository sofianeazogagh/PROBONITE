...
Ciphertext<DCRTPoly> OneHotSlot(Ciphertext<DCRTPoly> cta, CryptoContext<DCRTPoly> cc, KeyPair<DCRTPoly> keyPair)
{
...
//   SecurityLevel securityLevel = HEStd_128_classic;
  ...
  auto ct_ohs = OneHotSlot(ctm,cc,keyPair);
  ...
  auto ct_res_rotsum = cc->EvalSum(ctmult, N);
  ...
  Plaintext result;
  cc->Decrypt(keyPair.secretKey, ct_res_rotsum, &result);
